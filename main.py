"""
WORDEL - A recreation of Wordle for the console!
Created by RR0
"""
...
def get_random_word(word_list):
  if words := [
      ...
      if len(word) == NUM_LETTERS and all(letter in ascii_letters
                                          for letter in word)
  ]:
...
def guess_word(previous_guesses):
  ...
  if len(guess) != NUM_LETTERS:
    console.print(f"Your guess must be {NUM_LETTERS} letters.",
                  style="warning")
    return guess_word(previous_guesses)
